...
class gen_pdf():
        ...
        def factura_pdf(self):
               ...
               # try:             
                page_layout.add(gen_pdf._build_itemized_description_table({'detalle':data['cuerpoDocumento'],'size':size}))

                if pagina_actual == pagina_final:
                        page_layout.add(gen_pdf._footer_page_table({'resumen':data['resumen']}))
